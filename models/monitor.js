...
const monitorSchema = new mongoose.Schema ({
    ...
    refreshRate: { type: Number, enum: [60, 72, 75, 144, 165, 175, 180, 240], required: true },
    responseTime: { type: String, enum: ['0.03ms' ,'0.3ms', '0.5ms', '1ms', '4ms', '5ms'], required: true },
    panelType: { type: String, enum: ['IPS', 'VA', 'TN', 'OLED', 'QD-OLED'], required: true },
